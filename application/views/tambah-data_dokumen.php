                    ...
                    <form onsubmit="return Validate(this);" action="<?php echo base_url(). 'c_data_dokumen/tambah_data_dokumen' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="jns_dok" style="width: 100%;" name="jenis_dok" value="-Pilih-" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="cs">
                        </div>
                        <div class="form-group">
