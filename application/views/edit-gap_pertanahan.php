            ...
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Edit Pertanahan</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <?php foreach ($pertanahan as $li) :?>
                    <form onsubmit="return Validate(this);" action="<?php echo base_url(). 'c_gap_pertanahan/update_pertanahan' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                            ...
                            <div class="form-group">
                                <input type="hidden" class="form-control"   name="id_pertanahan" value="<?php echo $li->id_pertanahan;?>">
                            </div>
...
$('div.sese select').val('wonosari').change();
});
</script>
<script>
