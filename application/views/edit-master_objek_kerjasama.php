    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          if($role_id == 1){ ?>
          <li class="nav-item ">
            <a href="<?php echo base_url() ?>c_master_objek_kerjasama" class="nav-link ">
            <i class="nav-icon fab fa-buffer"></i>
              <p>
              Master Objek Kerjasama
              </p>
            </a>
          </li>
          <?php }?>
            ...
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Tambah Objek Kerjasama</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <?php foreach ($objek_kerjasama as $jd) :?>
                    <form action="<?php echo base_url(). 'c_master_objek_kerjasama/update_objek_kerjasama' ?>" method="post">
                      <div class="card-body">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Nama</label>
                          <input type="hidden" class="form-control" id="exampleInputEmail1"  name="id_objek_kerjasama" value="<?php echo $jd->id_objek_kerjasama ?>">
                          <input type="text" class="form-control" id="exampleInputEmail1"  name="nama_objek_kerjasama" value="<?php echo $jd->nama_objek_kerjasama ?>">
                        </div>
                        <div class="form-group">
