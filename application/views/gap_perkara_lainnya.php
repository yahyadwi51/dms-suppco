...
$(document).ready(function(){
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-2 mb-3">
                                <a href="<?php echo base_url() ?>c_gap_perkara_lainnya/form_perkara"><button type="button" class="btn btn-block btn-success btn-s">Tambah </button></a>
                            </div>
                            <div class="col-md-2 mb-3">
                              <div class="btn-group">
                                ...
                                <div class="dropdown-menu" role="menu">
                                  <a class="dropdown-item" href="<?php echo base_url() ?>c_laporan_gap_analysis/excel_perkara_lainnya">Excel</a>
                                  <a class="dropdown-item" href="<?php echo base_url() ?>c_laporan_gap_analysis/pdf_perkara_lainnya">PDF</a>
                                </div>
                              </div>
                            </div>
                      ...
                      <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td>
                                <?php
                                    $id_detail = $pk['id_perkara_lainnya'];

                                    $update_kondisi= $this->db->query("SELECT * FROM gap_histori_perkara_lainnya WHERE id_perkara_lainnya= $id_detail  ORDER BY tanggal_update DESC LIMIT 1");
  ...
  <div class="modal fade" id="modalhapus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form action="<?= base_url().'c_gap_perkara_lainnya/nonaktif/'?>" method="post">
  ...
  <div class="modal fade" id="modalaktif" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form action="<?= base_url().'c_gap_perkara_lainnya/aktif/'?>" method="post">
          <div class="modal-header">
  ...
  <script type="text/javascript">
      ...
      function status_surat(){
        ...
        $.ajax({
          url : "<?php echo base_url('c_gap_perkara_lainnya/load_status_surat') ?>",
