                          ...
                          <div class="form-group col-6">
                            <label>Bagian</label>
                              ...
                              <?php foreach ($bagian as $r) : ?>
                                  <option value="<?php echo $r->id_bagian;?>">
...
<!-- ./wrapper -->
      ...
      function add_file1()
      {
      $(".file_div1").append(" <div><input type='text' class='form-control' id='exampleInputEmail1' name='id_telegram[]'><input class='btn btn-danger mt-1' type='button' value='-' onclick=remove_file(this); style='width:40px;height:40px;margin-left:3px;margin-bottom:10px'></div>");
      }
