    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            <a href="<?php echo base_url() ?>c_gap_legal_ijin" class="nav-link ">
            ...
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Edit Legalitas dan Perijinan</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <?php foreach ($legal_ijin as $li) :?>
                    <form onsubmit="return Validate(this);" action="<?php echo base_url(). 'c_gap_legal_ijin/update_legal_ijin' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                      <input type="hidden" name="id" class="form-control" value="<?php echo $li->id_legal_ijin ?>" >
                            <div class="form-group">
                                <label>Jenis Kepatuhan</label>
                                    <select class="form-control select2" style="width: 100%;" name="jenis_kepatuhan">
                                        <?php foreach ($jenis_kepatuhan as $jk) : ?>
                                            <option value="<?php echo $jk->id_jen_kep;?>"  
                                            <?php 
                                                if ($jk->id_jen_kep == $li->jenis_kepatuhan) {
                                                    echo "selected";
                                                  }
                                            ?> >
                                            <?php echo $jk->nama_jen_kep?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nomor KTUN</label>
                                <input type="text" class="form-control" id="exampleInputEmail1"  name="no_ktun"  value="<?php echo $li->no_ktun ?>">
                            </div>
                            <div class="row">
                              <div class="form-group  col-md-4">
                                  <label>Tanggal  Terbit</label>
                                      <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                          <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" value="<?php echo date('d-m-Y', strtotime($li->tanggal_terbit)) ?>" name="tanggal_terbit" required/>
                              ...
                              <div class="form-group col-md-4">
                                  <label>Tanggal  Berakhir</label>
                                      <div class="input-group date" id="reservationdate1" data-target-input="nearest">
                                          <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate1" value="<?php echo date('d-m-Y', strtotime($li->tanggal_berakhir)) ?>" name="tanggal_berakhir" required/>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1"  name="kabupaten"  value="<?php echo $li->kabupaten ?>">
                            </div>
                            
                            
                            <div class="form-group">
                                <label for="inputDescription">Proses saat ini</label>
