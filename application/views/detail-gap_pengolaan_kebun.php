  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Pengelolaan Kebun</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Pengelolaan kebun</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
                            ...
                            <div class="col-md-10 mb-3">
                                ...
                                <table width="1000">
                                    <tbody>
                                        <?php
                                        $no=0;
                                        foreach ($pengelolaan_kebun as $li) :
                                        $no++;
                                        ?>
                                        <tr>
                                        <th width="250">Nomor Perjanjian</th><td width="500">: <?php echo $li['no_perjanjian'] ?></td>
                                        <th width="250">Kebun</th><td width="500">: <?php echo $li['nama_bagian'] ?></td>
                                        </tr>
                                        <tr>
                                        <th>Kerjasama</th> <td>: <?php echo $li['kerjasama'] ?></td>
                                        <th>Jenis Kerjasama</th> <td>: <?php echo $li['nama'] ?></td>
                                        </tr>
                                        <tr>
                                        <th>Mitra</th><td>: <?php echo $li['mitra'] ?></td>
                                        <th>Luas</th><td>: <?php echo $li['luas'] ?></td>
                                        </tr>
                                        <tr>
                                        <th>Titik Koordinat Longitude</th><td>: <?php echo $li['tk_long'] ?></td>
                                        <th>Titik Koordinat Latiitude</th><td>: <?php echo $li['tk_lat'] ?></td>
                                        </tr>
                                        <tr>
                                        <th>Nilai Kompensasi</th><td>: <?php echo $li['nilai_kompensasi'] ?></td>
                                        <th>Objek Kerjasama</th><td>: <?php echo $li['nama_objek_kerjasama'] ?></td>
                                        </tr>
                                        <tr>
                                        <th>Tanggal Perjanjian</th><td>: <?php $newDate = date("d-m-Y", strtotime($li['tanggal_perjanjian'])); echo $newDate ;?></td>
                                        <th>Tanggal Akhir Perjanjian</th><td>: <?php $newDate = date("d-m-Y", strtotime($li['tanggal_akhir_perjanjian'])); echo $newDate ;?></td>
                                        </tr>
                                        <tr>
                                        <th>Jangka Waktu</th><td>: <?php echo $li['jangka_waktu'] ?></td>
                                        <th>Kondisi saat ini</th><td>: <?php echo $li['kondisi_saat_ini'] ?></td>
                                        </tr>
                                        <tr>
                                        <th>Keterangan</th><td>: <?php echo $li['ketpengkeb'] ?></td>
                                        <th>Upload Dokumen</th><td>: <?php echo $li['upload_dokumen'] ?></td>
                                        </tr>
                                        <?php endforeach; ?>
                            ...
                            <!-- select -->
                                <div class="form-group">
                                    <select class="custom-select" id="dynamic_select">
                                        ...
                                        <option value="<?php echo base_url() ?>c_laporan_gap_analysis/excel_ksi_pengelolaan_kebun/<?php echo $li['id_olah_keb'] ?>">Excel</option>
                                        <option value="<?php echo base_url() ?>c_laporan_gap_analysis/pdf_ksi_pengelolaan_kebun/<?php echo $li['id_olah_keb'] ?>">PDF</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                      <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button type="button" class="btn  btn-primary btn-sm" id="<?php echo $ksi['histori_upload_dokumen'] ?>" value="<?php echo $ksi['id_histori_peng_keb'] ?>,<?php echo $ksi['id_peng_keb'] ?>,<?php echo $ksi['histori_kondisi_saat_ini'] ?>,<?php echo $ksi['tanggal_update'] ?>" onClick="kirimupdate(this.value,this.id)" data-toggle="modal" data-target="#modal-edit" title="Edit"><i class="far fa-edit"></i></button></td>
          ...
          <div class="modal fade" id="modal-edit">
              ...
              <div class="modal-content">
                  ...
                  <form onsubmit="return Validate(this);" action="<?php echo base_url() ?>c_gap_pengelolaan_kebun/update_detail_pengelolaan_kebun"  method="post" enctype="multipart/form-data">
                  <div class="modal-body">
                  <input type="hidden" class="form-control"  name="id_histori_peng_keb" id="myText1">
                  <input type="hidden" class="form-control"  name="id_peng_keb" id="myText2">
                      <div class="form-group">
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form onsubmit="return Validate(this);" action="<?php echo base_url() ?>c_gap_pengelolaan_kebun/tambah_detail_pengelolaan_kebun"  method="post" enctype="multipart/form-data">
            <div class="modal-body">
            <?php
            $no=0;
            foreach ($pengelolaan_kebun as $li) :
            $no++;
            ?>
            <input type="hidden" class="form-control"  name="id_olah_keb" value="<?php echo $li['id_olah_keb'] ?>">
            <?php endforeach; ?>
                <div class="form-group">
                    <label for="inputDescription">Kondisi Saat Ini</label>
