            ...
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Tambah Pengelolaan Kebun</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form onsubmit="return Validate(this);" action="<?php echo base_url(). 'c_gap_pengelolaan_kebun/tambah_pengelolaan_kebun' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                        <div class="row"> 
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nomor Perjanjian</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1"  name="no_perjanjian">
                                </div>
                            </div>  
                            <div class="col-md-6">
                              <div class="form-group">
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"  name="kerjasama">
                                </div>
                            </div> 
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    <label>Jenis Kerjasama</label>
                                        <select class="form-control select2" style="width: 100%;" name="jenis_kerjasama">
                                        <option selected>- Pilih Kerjasama - </option>
                                            <?php foreach ($kerjasama as $k) : ?>
                                                <option value="<?php echo $k['id_kerjasama'];?>">
                                                <?php echo $k['nama']?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"  name="mitra">
                                </div>
                            </div> 
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Luas (Ha)</label>
                                    <input type="number" class="form-control" id="exampleInputEmail1"  name="luas">
                                </div>
                            </div> 
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Titik Koordinat Longitude</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1"  name="tk_long">
                                </div>
                            </div> 
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Titik Koordinat Latitude</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1"  name="tk_lat">
                                </div>
                            </div> 
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nilai Kompensasi</label>
                                    <input type="number" class="form-control" id="exampleInputEmail1"  name="nilai_kompensasi">
                                </div>
                            </div> 
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    <label>Objek Kerjasama</label>
                                        <select class="form-control select2" style="width: 100%;" name="objek_kerjasama">
                                        <option selected>- Pilih Objek Kerjasama - </option>
                                            <?php foreach ($objek_kerjasama as $ok) : ?>
                                                <option value="<?php echo $ok['id_objek_kerjasama'];?>">
                                ...
                                <div class="form-group">
                                    <label>Tanggal Perjanjian</label>
                                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" name="tanggal_perjanjian" required/>
                                ...
                                <div class="form-group">
                                    <label>Tanggal Berakhir Perjanjian</label>
                                        <div class="input-group date" id="reservationdate1" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate1" name="tanggal_akhir_perjanjian" required/>
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="exampleInputEmail1"  name="jangka_waktu">
                                </div>
                            </div> 
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    <label for="inputDescription">Kondisi Saat Ini</label>
                                    <textarea id="inputDescription" class="form-control" rows="4" name="kondisi_saat_ini"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6"> 
                                <div class="form-group">
