    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            <a href="<?php echo base_url() ?>c_gap_permasalahan_hub_industrial" class="nav-link ">
            ...
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Edit Permasalahan Hubungan Industrial</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <?php  foreach ($permasalahan_hub_industrial as $li) :?>
                    <form onsubmit="return Validate(this);" action="<?php echo base_url(). 'c_gap_permasalahan_hub_industrial/update_permasalahan_hub_industrial' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Subjek</label>
                                <input type="text" class="form-control" id="exampleInputEmail1"  name="subjek" value="<?php echo $li->subjek ?>">
                                <input type="hidden" class="form-control" id="exampleInputEmail1"  name="id" value="<?php echo $li->id_permasalahan ?>">
                            </div>
                            <div class="form-group">
                                <label>Kebun</label>
                                <?php 
                            ...
                            <div class="form-group">
                                <label>Waktu</label>
                                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" name="waktu" value="<?php echo date('d-m-Y', strtotime($li->waktu)) ?>" required/>
                            ...
                            <div class="form-group">
                                <label for="inputDescription">Lokasi</label>
                                <textarea id="inputDescription" class="form-control" rows="4" name="lokasi"><?php echo $li->lokasi ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="inputDescription">Kerugian</label>
                                <textarea id="inputDescription" class="form-control" rows="4" name="kerugian"><?php echo $li->kerugian ?></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="inputDescription">Upaya Penyelesaian</label>
                                <textarea id="inputDescription" class="form-control" rows="4" name="upaya_penyelesaian"><?php echo $li->upaya_penyelesaian ?></textarea>
                            </div>
                            <div class="form-group">
