          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <?php foreach ($user as $user): ?>
                <form action="<?php echo base_url() . 'c_master_userdms/update_userdms' ?>" method="post">
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Username"
                        name="username" value="<?php echo $user->username; ?>" readonly>
                    </div>
                    ...
                    <?php if ($sesi_region == 13) { ?>
                      ...
                      <div class="form-group col-6">
                        ...
                        <select class="form-control select2" name="role" id="role">
                          ...
                          <?php foreach ($user_role as $user_role): ?>
                            <option value="<?php echo $user_role['id']; ?>" <?php
                      ...
                      <div class="form-group col-6">
                        ...
                        <select class="form-control select2" style="width: 100%;" name="region" id="region">
                          ...
                          <?php foreach ($regionuserho as $reguserho): ?>
                            <option value="<?php echo $reguserho['id_regional']; ?>" <?php
                               if ($reguserho['id_regional'] == $user->id_region) {
                                 echo "selected";
                               }
                               ?>>
                      ...
                      <div class="form-group col-6">
                        ...
                        <select class="form-control select2" name="bagian" id="bagian">
                          ...
                          <?php foreach ($baguser as $baguser): ?>
                            <option value="<?php echo $baguser['id_bagian']; ?>" <?php
                               if ($baguser['id_bagian'] == $user->id_bagian) {
                                 echo "selected";
                               }
                               ?>>
                      ...
                      <div class="form-group col-6">
                        ...
                        <select class="form-control select2" name="subbagian" id="subbagian">
                          <option value="">Pilih Nama Sub-Bagian</option>
                          <?php foreach ($subbaguser as $subbaguser): ?>
                            <option value="<?php echo $subbaguser['id_sub_bag']; ?>" <?php
                               if ($subbaguser['id_sub_bag'] == $user->id_sub_bagian) {
                                 echo "selected";
                               }
                               ?>>
                              <?php echo $subbaguser['nama_sub_bag'] ?>
                            </option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                      ...
                      <!-- <script>
                        $(document).ready(function () {
                          // var selectedBagianId = '<?php echo $user->id_bagian; ?>'; 
                          // $('#bagian').val(selectedBagianId);
                          // console.log('DONCAK DANCOK ' + selectedBagianId);
                            ...
                            if (region_id !== '') {
                              ...
                              $.ajax({
                                ...
                                success: function (response) {
                                  ...
                                  // $('#bagian').val(selectedBagianId); // Setelah menambahkan opsi-opsi baru
                                  // console.log('DONCAK DANCOK ' + selectedBagianId);
                                }
                              });
                            } else {
                      ...
                      <div class="form-group col-6">
                        ...
                        <select class="form-control select2" style="width: 100%;" name="region" id="region" disabled>
                          <?php foreach ($regionuser as $reguser): ?>
                            <option value="<?php echo $reguser['id_regional']; ?>">
                    ...
                    <div class="form-group col-6">
                      ...
                      <select class="form-control select2" style="width: 100%;" name="status">
                        ...
                        <option value="0" <?php echo $user->is_active == 0 ? 'selected' : ''; ?>>Non-Active</option>
                      </select>
                    </div>
                    <div class="form-group col-4">
                      <label for="exampleInputEmail1">ID Telegram</label>
                      <div class="file_div1">
                        <?php $id_telegram_arr = explode(',', $user->id_telegram); ?>
                        <?php foreach ($id_telegram_arr as $id_telegram): ?>
                          <div>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder=""
                              name="id_telegram[]" value="<?php echo $id_telegram; ?>">
                          </div>
                        <?php endforeach; ?>
                        <input class="btn btn-primary mt-1" type="button" onclick="add_file1();" value="+"
                    ...
                    <div class="form-group col-4">
                      ...
                      <div class="file_div2">
                        <?php $notelp_arr = explode(',', $user->no_telp); ?>
                        <?php foreach ($notelp_arr as $notelp): ?>
                          <div>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="" name="no_telp[]"
                              value="<?php echo $notelp; ?>">
                          </div>
                        <?php endforeach; ?>
                        <input class="btn btn-primary mt-1" type="button" onclick="add_file2();" value="+"
                          style="width:40px;height:40px;margin-bottom:10px">
                      </div>
                    </div>
                    <div class="form-group col-4">
                      ...
                      <div class="file_div3">
                        <?php $email_arr = explode(',', $user->email); ?>
                        <?php foreach ($email_arr as $email): ?>
                          <div>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="" name="email[]"
                              value="<?php echo $email; ?>">
                          </div>
                        <?php endforeach; ?>
                        <input class="btn btn-primary mt-1" type="button" onclick="add_file3();" value="+"
                          style="width:40px;height:40px;margin-bottom:10px">
                      </div>
                    </div>
                    <!-- /.card-body -->
...
<script type="text/javascript">
  function add_file1() {
    $(".file_div1").append("<div><input type='text' class='form-control' id='exampleInputEmail1' name='id_telegram[]' value=''><input class='btn btn-danger mt-1' type='button' value='-' onclick=remove_file(this); style='width:40px;height:40px;margin-left:3px;margin-bottom:10px'></div>");
  }

  function remove_file(ele) {
    // Hapus elemen parent (div input) hanya jika ada lebih dari satu input tersisa
    if ($(".file_div1 div").length > 1) {
      $(ele).parent().remove();
    } else {
      // Jika hanya satu input tersisa, kosongkan nilainya (tanpa menghapus elemen dari DOM)
      $(ele).prev().val('');
    }
  }
</script>
<script type="text/javascript">
  function add_file2() {
    $(".file_div2").append(" <div><input type='text' class='form-control' id='exampleInputEmail1' name='no_telp[]'><input class='btn btn-danger mt-1' type='button' value='-' onclick=remove_file(this); style='width:40px;height:40px;margin-left:3px;margin-bottom:10px'></div>");
  }
  function remove_file(ele) {
    $(ele).parent().remove();
  }
...
<script type="text/javascript">
  function add_file3() {
    $(".file_div3").append(" <div><input type='text' class='form-control' id='exampleInputEmail1' name='email[]'><input class='btn btn-danger mt-1' type='button' value='-' onclick=remove_file(this); style='width:40px;height:40px;margin-left:3px;margin-bottom:10px'></div>");
  }
  function remove_file(ele) {
    $(ele).parent().remove();
  }
