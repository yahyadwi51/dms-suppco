...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper" style="margin-right: 250px">
      ...
      $tanggal = $this->session->userdata('tanggal_penetapan');
      $jenis_dok = $this->session->userdata('jenis_dokumen');
      $nama_dokumen = $this->session->userdata('nama_dokumen');
      $tentang = $this->session->userdata('tentang');
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" name="tanggal_penetapan" autocomplete="off" value="<?php echo $tanggal; ?>" required />
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="inputDescription" class="form-control" rows="4" name="tentang"><?php echo $tentang; ?></textarea>
                    </div>
