            ...
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Tambah Permasalahan Hubungan Industrial</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form onsubmit="return Validate(this);" action="<?php echo base_url(). 'c_gap_permasalahan_hub_industrial/tambah_permasalahan_hub_industrial' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Subjek</label>
                                <input type="text" class="form-control" id="exampleInputEmail1"  name="subjek">
                            </div>
                            <div class="form-group">
                                <label>Kebun</label>
                                <?php 
                            ...
                            <div class="form-group">
                                <label>Waktu</label>
                                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" name="waktu" required/>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="inputDescription" class="form-control" rows="4" name="lokasi"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="inputDescription">Kerugian</label>
                                <textarea id="inputDescription" class="form-control" rows="4" name="kerugian"></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="inputDescription" class="form-control" rows="4" name="upaya_penyelesaian"></textarea>
                            </div>
                            <div class="form-group">
