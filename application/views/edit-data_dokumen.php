...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="row">
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    ...
                    <form onsubmit="return Validate(this);" action="<?php echo base_url(). 'c_data_dokumen/update_data_dokumen' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                            ...
                            <option selected>- Pilih Jenis Dokumen - </option>
                              ...
                              <div class="row">
                                ...
                                <div class="input-group mb-3 col-3">
                                  <input type="number" class="form-control" id="durasi_tahun" onKeyPress="if(this.value.length==2) return false;"  name="drs_tahun">
                                  <div class="input-group-append">
                                    <span class="input-group-text">Tahun</span>
                                  </div>
                                </div>
                                <div class="input-group mb-3 col-3">
                                <input type="number" class="form-control"  id="durasi_bulan" onKeyPress="if(this.value.length==2) return false;"  name="drs_bulan">
                                  <div class="input-group-append">
                                ...
                                <div class="input-group mb-3 col-3">
                                  <input type="number" class="form-control"  id="durasi_hari" onKeyPress="if(this.value.length==2) return false;" name="drs_hari">
                                  <div class="input-group-append">
                        ...
                        <div class="form-group">
                            <label>PIC</label>
                            <select class="form-control select2" style="width: 100%;" name="pic">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="cs" value="<?php echo $dd->cs ?>">
                        </div>
                        ...
                        <?php echo anchor('c_data_dokumen/hapusdokumen/'.$dd->id, '<button type="button" class="btn  btn-danger btn-sm " title="Hapus">Hapus Dokumen Upload</button>') ?>
                      </div>
                      <!-- /.card-body -->
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="<?= base_url();?>">DMS SuppCo</a>.</strong>
    All rights reserved.
