        ...
        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <table width="1000">
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                        <th width="200">Subjek</th><td width="700">: <?php echo $li['subjek'] ?></td>
                                        </tr>
                                        <tr>
                                        <th width="200">Waktu</th> <td width="700">: <?php echo $li['waktu'] ?></td>
                                        </tr>
                                        <tr>
                                        <th width="200">Lokasi</th> <td width="700">: <?php echo $li['lokasi'] ?></td>
                                        </tr>
                                        <tr>
                                        <th width="200">Kondisi saat Ini</th> <td width="700">: <?php echo $li['kondisi_saat_ini'] ?></td>
                                        </tr>
                                        <tr>
                                        <th width="200">Upaya</th><td width="700">: <?php echo $li['upaya'] ?></td>
                                        </tr>
                                        <tr>
                                        <th width="200">Keterangan</th><td width="700">: <?php echo $li['keterangan'] ?></td>
                                        </tr>
                                        <?php endforeach; ?>
                            ...
                            <!-- select -->
                                <div class="form-group">
                                    <select class="custom-select" id="dynamic_select">
                                        ...
                                        <option value="<?php echo base_url() ?>c_laporan_gap_analysis/excel_ksi_non_perkara/<?php echo $li['id_non_pekara'] ?>">Excel</option>
                                        <option value="<?php echo base_url() ?>c_laporan_gap_analysis/pdf_ksi_non_perkara/<?php echo $li['id_non_pekara'] ?>">PDF</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                      <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button type="button" class="btn  btn-primary btn-sm" id="<?php echo $ksi['histori_upload_dokumen'] ?>" value="<?php echo $ksi['id_histori_non_perkara'] ?>,<?php echo $ksi['id_non_pekara'] ?>,<?php echo $ksi['histori_kondisi_saat_ini'] ?>,<?php $date=date_create($ksi['tanggal_update']);$formattgl = date_format($date,"d-m-Y");echo $formattgl; ?>" onClick="kirimupdate(this.value,this.id)" data-toggle="modal" data-target="#modal-edit" title="Edit"><i class="far fa-edit"></i></button></td>
          ...
          <div class="modal fade" id="modal-edit">
              ...
              <div class="modal-content">
                  ...
                  <form onsubmit="return Validate(this);" action="<?php echo base_url() ?>c_gap_non_perkara/update_detail_non_perkara"  method="post" enctype="multipart/form-data">
                  <div class="modal-body">
                  <input type="hidden" class="form-control"  name="id_histori_non_perkara" id="myText1">
                  <input type="hidden" class="form-control"  name="id_non_perkara" id="myText2">
                      <div class="form-group">
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form onsubmit="return Validate(this);" action="<?php echo base_url() ?>c_gap_non_perkara/tambah_detail_non_perkara"  method="post" enctype="multipart/form-data">
            <div class="modal-body">
            <?php
            $no=0;
            foreach ($perkara as $li) :
            $no++;
            ?>
            <input type="hidden" class="form-control"  name="id_non_pekara" value="<?php echo $li['id_non_pekara'] ?>">
            <?php endforeach; ?>
                <div class="form-group">
                    <label for="inputDescription">Kondisi Saat Ini</label>
