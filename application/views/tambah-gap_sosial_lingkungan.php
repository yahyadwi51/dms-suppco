            ...
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Tambah Sosial dan Lingkungan</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form onsubmit="return Validate(this);" action="<?php echo base_url(). 'c_gap_sosial_lingkungan/tambah_sosial_lingkungan' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                        <div class="row"> 
                            <div class="col-md-6"> 
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    <label for="inputDescription">Kondisi Saat Ini 10 Tahun Terakhir terhitung sejak tanggal input</label>
                                    <textarea id="inputDescription" class="form-control" rows="4" name="kondisi_10thn_terakhir"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6"> 
                                <div class="form-group">
