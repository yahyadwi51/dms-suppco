        ...
        <div class="row">
                            ...
                            <!-- select -->
                                <div class="form-group">
                                    <select class="custom-select" id="dynamic_select">
                                        ...
                                        <option value="<?php echo base_url() ?>c_laporan_gap_analysis/excel_ksi_perkara/<?php echo $li['id_perkara'] ?>">Excel</option>
                                        <option value="<?php echo base_url() ?>c_laporan_gap_analysis/pdf_ksi_perkara/<?php echo $li['id_perkara'] ?>">PDF</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                      <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button type="button" class="btn  btn-primary btn-sm" id="<?php echo $ksi['histori_upload_dokumen'] ?>" value="<?php echo $ksi['id_histori_perkara'] ?>,<?php echo $ksi['id_perkara'] ?>,<?php echo $ksi['histori_kondisi_saat_ini'] ?>,<?php echo $ksi['tanggal_update'] ?>" onClick="kirimupdate(this.value,this.id)" data-toggle="modal" data-target="#modal-edit" title="Edit"><i class="far fa-edit"></i></button></td>
          ...
          <div class="modal fade" id="modal-edit">
              ...
              <div class="modal-content">
                  ...
                  <form onsubmit="return Validate(this);" action="<?php echo base_url() ?>c_gap_perkara/update_detail_perkara"  method="post" enctype="multipart/form-data">
                  <div class="modal-body">
                  <input type="hidden" class="form-control"  name="id_histori_perkara" id="myText1">
                  <input type="hidden" class="form-control"  name="id_perkara" id="myText2">
                      <div class="form-group">
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form onsubmit="return Validate(this);" action="<?php echo base_url() ?>c_gap_perkara/tambah_detail_perkara"  method="post" enctype="multipart/form-data">
            <div class="modal-body">
            <?php
            $no=0;
            foreach ($perkara as $li) :
            $no++;
            ?>
            <input type="hidden" class="form-control"  name="id_perkara" value="<?php echo $li['id_perkara'] ?>">
            <?php endforeach; ?>
                <div class="form-group">
                    <label for="inputDescription">Kondisi Saat Ini</label>
