  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Perkara Lainnya</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Perkara Lainnya</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <table width="1000" >
                                    ...
                                    <tbody >
                                        <?php
                                        $no=0;
                                        foreach ($perkara as $li) :
                                        $no++;
                                        ?>
                                        <tr>
                                        <th width="200">Subjek</th><td width="500">: <?php echo $li['subjek'] ?></td>
                                        </tr>
                                        <tr>
                                        <th width="200">Waktu</th> <td width="500"> : <?php $newDate = date("d-m-Y", strtotime($li['waktu'])); echo $newDate ;?></td>
                                        </tr>
                                        <tr>
                                        <th width="200">Lokasi</th> <td width="500">: <?php echo $li['lokasi'] ?></td>
                                        </tr>
                                        <tr>
                                        <th width="200">Kondisi saat Ini</th> <td width="500">: <?php echo $li['kondisi_saat_ini'] ?></td>
                                        </tr>
                                        <tr>
                                        <th width="200">Upaya</th><td width="500">: <?php echo $li['upaya'] ?></td>
                                        </tr>
                                        <tr>
                                        <th width="200">Keterangan</th><td width="500">: <?php echo $li['keterangan'] ?></td>
                                        </tr>
                                        <?php endforeach; ?>
                            ...
                            <!-- select -->
                                <div class="form-group">
                                    <select class="custom-select" id="dynamic_select">
                                        ...
                                        <option value="<?php echo base_url() ?>c_laporan_gap_analysis/excel_ksi_perkara_lainnya/<?php echo $li['id_perkara_lainnya'] ?>">Excel</option>
                                        <option value="<?php echo base_url() ?>c_laporan_gap_analysis/pdf_ksi_perkara_lainnya/<?php echo $li['id_perkara_lainnya'] ?>">PDF</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                      <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button type="button" class="btn  btn-primary btn-sm" id="<?php echo $ksi['histori_upload_dokumen'] ?>" value="<?php echo $ksi['id_histori_perkara_lainnya'] ?>,<?php echo $ksi['id_perkara_lainnya'] ?>,<?php echo $ksi['histori_kondisi_saat_ini'] ?>,<?php echo $ksi['tanggal_update'] ?>" onClick="kirimupdate(this.value,this.id)" data-toggle="modal" data-target="#modal-edit" title="Edit"><i class="far fa-edit"></i></button></td>
          ...
          <div class="modal fade" id="modal-edit">
              ...
              <div class="modal-content">
                  ...
                  <form onsubmit="return Validate(this);" action="<?php echo base_url() ?>c_gap_perkara_lainnya/update_detail_perkara"  method="post" enctype="multipart/form-data">
                  <div class="modal-body">
                  <input type="hidden" class="form-control"  name="id_histori_perkara_lainnya" id="myText1">
                  <input type="hidden" class="form-control"  name="id_perkara_lainnya" id="myText2">
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          <label>Tanggal</label>
                              <div class="input-group date" id="reservationdate1" data-target-input="nearest">
                                  <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate1" name="tanggal_update" id="myText4" required/>
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form onsubmit="return Validate(this);" action="<?php echo base_url() ?>c_gap_perkara_lainnya/tambah_detail_perkara"  method="post" enctype="multipart/form-data">
            <div class="modal-body">
            <?php
            $no=0;
            foreach ($perkara as $li) :
            $no++;
            ?>
            <input type="hidden" class="form-control"  name="id_perkara_lainnya" value="<?php echo $li['id_perkara_lainnya'] ?>">
            <?php endforeach; ?>
                <div class="form-group">
                    <label for="inputDescription">Kondisi Saat Ini</label>
