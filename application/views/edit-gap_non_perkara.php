    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          if($role_id == 1){ ?>
          <li class="nav-item ">
            <a href="<?php echo base_url() ?>c_gap_perkara" class="nav-link ">
        ...
        <div class="row">
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <?php foreach ($perkara as $li) :?>
                    <form onsubmit="return Validate(this);" action="<?php echo base_url(). 'c_gap_non_perkara/update_non_perkara' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                            <div class="form-group">
                                <label for="inputDescription">Subjek</label>
                                <input type="hidden" class="form-control" id="exampleInputEmail1"  name="id" value="<?php echo $li->id_non_pekara ?>">
                            ...
                            <div class="form-group">
                                <label>Waktu</label>
                                    <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" name="waktu" value="<?php echo $li->waktu ?>"required/>
                            ...
                            <div class="form-group">
                                <label for="inputDescription">Kondisi Terkini</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="inputDescription" class="form-control" rows="4" name="upaya"><?php echo $li->upaya ?></textarea>
                            </div>
                            <div class="form-group">
