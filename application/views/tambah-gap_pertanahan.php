                    ...
                    <form onsubmit="return Validate(this);" action="<?php echo base_url(). 'c_gap_pertanahan/tambah_pertanahan' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Nomor Hak Atas Tanah</label>
                                    <select class="form-control select2" style="width: 100%;" name="no_hgu">
                                    <option selected>- Pilih Nomor Hak Atas Tanah - </option>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Tanah Belum Digarap ?</label>
                            </div>
                            <div class="row">
                                <!-- checkbox -->
                                <div class="form-group col-md-1">
                                    <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" id="customRadio1" onclick="show1();" value="1" name="tanah_belum_digarap">
                                    <label for="customRadio1" class="custom-control-label">Iya</label>
                                    </div>
                                </div>
                                <div class="form-group col-md-2">
                                    <div class="custom-control custom-radio">
                                    <input class="custom-control-input" type="radio" id="customRadio2" onclick="show2();" value="2" name="tanah_belum_digarap" checked>
                                    <label for="customRadio2" class="custom-control-label">Tidak</label>
                                    </div>
                                </div>
                            </div>
                            <div class="card card-primary card-outline" id="div1">
                                <div class="card-header">
                                    <h5 class="m-0">Areal Konsesi/Cadangan/Tunggu</h5>
                                </div>
                                <div class="card-body">
                                    <input type="hidden" value="1" name="id_tanah[]">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            <label>Kategorisasi</label>
                                                <select class="form-control select2" style="width: 100%;" name="kategorisasi" required>
                                                <option value="0" selected>- Pilih Kategorisasi - </option>
