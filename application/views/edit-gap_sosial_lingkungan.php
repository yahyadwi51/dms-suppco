...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            <a href="<?php echo base_url() ?>c_gap_sosial_lingkungan" class="nav-link ">
            ...
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Edit Sosial dan Lingkungan</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <?php  foreach ($sosial_lingkungan as $li) :?>
                    <form onsubmit="return Validate(this);" action="<?php echo base_url(). 'c_gap_sosial_lingkungan/update_sosial_lingkungan' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                        <div class="row"> 
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    <label>LSM/Tokoh Masyarakat/Instansi</label>
                                        <select class="form-control select2" style="width: 100%;" name="nama_lsm">
                                        <option selected>- Pilih LSM/Tokoh Masyarakat/Instansi - </option>
                                            <?php foreach ($master_lsm as $nh) : ?>
                                                <option value="<?php echo $nh['id_lsm'];?>"
                                                <?php 
                                                if ($nh['id_lsm'] == $li->nama_lsm) {
                                                    echo "selected";
                                                  }
                                                ?>>
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" id="exampleInputEmail1"  name="id"  value="<?php echo $li->id_sos_lik ?>">
                                    <input type="text" class="form-control" id="exampleInputEmail1"  name="lokasi"  value="<?php echo $li->lokasi ?>">
                                </div>
                            </div> 
                            
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    <label for="inputDescription">Kondisi Saat Ini 10 Tahun Terakhir</label>
                                    <textarea id="inputDescription" class="form-control" rows="4" name="kondisi_10thn_terakhir"><?php echo $li->kondisi_10thn_terakhir ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6"> 
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Tanggal </label>
                                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" name="tanggal"  value="<?php echo $li->tanggal ?>"required/>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 <a href="<?= base_url();?>">Jasinfo</a>.</strong>
    All rights reserved.
