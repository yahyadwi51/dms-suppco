            ...
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Tambah Infrastruktur Pendukung</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form onsubmit="return Validate(this);" action="<?php echo base_url(). 'c_gap_infrastruktur_pendukung/tambah_infra_pend' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                            <div class="form-group">
                                <label>Jenis Infrastruktur</label>
                                    <select class="form-control select2" style="width: 100%;" name="jenis_infrastruktur">
                                        ...
                                        <option value="1">Infrastruktur Pengelolaan Kebun</option>
                                        <option value="2">Fasilitas Umum</option>
                                        <option value="3">Fasilitas Sosial</option>
                                    </select>
                            </div>
                            <div class="form-group">
                                <label>Kebun</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1"  name="nama_infra">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Luas Tanah(Ha)</label>
                                <input type="number" class="form-control" id="exampleInputEmail1"  name="luas_tanah">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Luas Bangunan(m<sup>2</sup>)</label>
                                <input type="number" class="form-control" id="exampleInputEmail1"  name="luas_bangunan">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="cv" name="upload_dokumen">
