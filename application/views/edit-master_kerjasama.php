    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          if($role_id == 1){ ?>
          <li class="nav-item ">
            <a href="<?php echo base_url() ?>c_master_kerjasama" class="nav-link ">
        ...
        <div class="row">
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <?php foreach ($kerjasama as $jd) :?>
                    <form action="<?php echo base_url(). 'c_master_kerjasama/update_kerjasama' ?>" method="post">
                      <div class="card-body">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Nama</label>
                          <input type="hidden" class="form-control" id="exampleInputEmail1"  name="id_kerjasama" value="<?php echo $jd->id_kerjasama ?>">
                          <input type="text" class="form-control" id="exampleInputEmail1"  name="nama" value="<?php echo $jd->nama ?>">
                        </div>
                        <div class="form-group">
