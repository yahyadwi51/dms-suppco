...
$(document).ready(function(){
                            ...
                            <div class="col-md-2 mb-3">
                              <div class="btn-group">
                                ...
                                <div class="dropdown-menu" role="menu">
                                  <a class="dropdown-item" href="<?php echo base_url() ?>c_laporan_gap_analysis/excel_legal_ijin">Excel</a>
                                  <a class="dropdown-item" href="<?php echo base_url() ?>c_laporan_gap_analysis/pdf_legal_ijin">PDF</a>
                                </div>
                              </div>
                            </div>
                      ...
                      <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody id="myTable">
                            ...
                            <tr>
                                ...
                                <td>
                                  <?php
                                    $id_detail = $li['id_legal_ijin'];

                                    $update_kondisi= $this->db->query("SELECT * FROM gap_histori_legal_ijin WHERE id_legal_ijin= $id_detail  ORDER BY tanggal_update DESC LIMIT 1");
  ...
  <div class="modal fade" id="modalhapus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form action="<?= base_url().'c_gap_legal_ijin/nonaktif/'?>" method="post">
  ...
  <div class="modal fade" id="modalaktif" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form action="<?= base_url().'c_gap_legal_ijin/aktif/'?>" method="post">
          <div class="modal-header">
