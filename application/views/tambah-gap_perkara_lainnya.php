    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            <a href="<?php echo base_url() ?>c_gap_perkara_lainnya" class="nav-link ">
            ...
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Tambah Perkara Lainnya</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form onsubmit="return Validate(this);" action="<?php echo base_url(). 'c_gap_perkara_lainnya/tambah_perkara' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="inputDescription" class="form-control" rows="4" name="upaya"></textarea>
                            </div>
                            <div class="form-group">
