            ...
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Tambah Legalitas dan Perijinan</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form onsubmit="return Validate(this);" action="<?php echo base_url(). 'c_gap_legal_ijin/tambah_legal_ijin' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                            <div class="form-group">
                                <label>Jenis Kepatuhan</label>
                                    <select class="form-control select2" style="width: 100%;" name="jenis_kepatuhan">
                                    <option selected>- Pilih Jenis Kepatuhan - </option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1"  name="no_ktun">
                            </div>
                              ...
                              <div class="form-group col-md-4">
                                  <label>Tanggal  Terbit</label>
                                      <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                          <input type="text" class="form-control datetimepicker-input"  name="tanggal_terbit"  required/>
                              ...
                              <div class="form-group col-md-4">
                                  <label>Tanggal  Berakhir</label>
                                      <div class="input-group date" id="reservationdate1" data-target-input="nearest">
                                          <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate1" name="tanggal_berakhir" required/>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1"  name="kabupaten">
                            </div>
                            <div class="form-group">
