        ...
        <div class="row">
            <div class="col-12 mt-3">
                <div class="card card-primary">
                    ...
                    <form onsubmit="return Validate(this);" action="<?php echo base_url(). 'c_gap_perkara/update_perkara' ?>" method="post" enctype="multipart/form-data">
                      <div class="card-body">
                      <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="exampleInputEmail1"  name="id" value="<?php echo $li->id_perkara ?>">
