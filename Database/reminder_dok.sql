...
(15, 5, '2020-11-20', 'Tes', 'combinepdf.pdf,Rekap Agenda 20201228-200420.pdf,');
...
(1, '2342342', '11111', '2020-12-31', '2020-12-30', 'b', 'b', 2, 'map_(5).kml', 1),
...
(2, 'd', 2342342, 'd', 1, 'd', 'd', 'd', 'd', 'd', 1, '2013-11-21', '2010-11-20', 0, 'd', 'd', '', 1),
(3, 'd', 2342342, 'd', 1, 'd', 'd', 'd', 'd', 'd', 1, '2020-11-13', '2010-11-30', 1, 'd', 'd', '', 0),
(4, 'd', 2342342, 'd', 2, 'd', 'd', 'd', 'd', 'd', 0, '2020-11-13', '2010-11-20', 2, 'd', 'd', '', 1);
...
CREATE TABLE IF NOT EXISTS `histori_download_dokumen` (
  ...
  `daerah` varchar(225) NOT NULL,
  `negara` varchar(225) NOT NULL,
  `lokasi` varchar(255) NOT NULL,
  `zonawaktu` varchar(255) NOT NULL,
  `nomor_peminta` varchar(120) NOT NULL
...
INSERT INTO `histori_download_dokumen` (`id`, `id_dokumen`, `status`, `keterangan`, `log`, `tanggal_download`, `kode_unik`, `peminta`, `pendownload`, `ip`, `browser`, `mac`, `os`, `kota`, `daerah`, `negara`, `lokasi`, `zonawaktu`, `nomor_peminta`) VALUES
(20, 5, 'Request', 'qweqwe', '2021-01-04 09:36:20', '', 'VUongrNaM95e', 'tanaman', '', '::1', 'Opera', '18-4F-32-5A-66-EE', 'Windows 10', 'Surabaya', 'East Java', 'ID', '-7.2492,112.7508', 'Asia/Jakarta', ''),
(24, 13, 'Ditolak', 'aa', '2021-01-06 02:03:25', '', '-', 'sekper', '', '::1', 'Opera', '18-4F-32-5A-66-EE', 'Windows 10', 'Surabaya', 'East Java', 'ID', '-7.2492,112.7508', 'Asia/Jakarta', '087865018862'),
(25, 13, 'Ditolak', 'asss', '2021-01-06 04:12:18', '06-01-2021', '-', 'sekper', '', '::1', 'Opera', '18-4F-32-5A-66-EE', 'Windows 10', 'Surabaya', 'East Java', 'ID', '-7.2492,112.7508', 'Asia/Jakarta', '087865018862');
...
CREATE TABLE IF NOT EXISTS `tb_dokumen` (
  ...
  `notif_hak_akses` int(11) NOT NULL,
  `notif_pic` int(11) NOT NULL
...
INSERT INTO `tb_dokumen` (`id`, `id_user`, `nama_dokumen`, `bag_or_keb`, `jenis_dok`, `masa_aktif_awal`, `masa_aktif_akhir`, `pic`, `cs`, `akses_for`, `upload_dokumen`, `pengingat`, `durasi_tahun`, `durasi_bulan`, `durasi_tgl`, `status_dokumen`, `notif_hak_akses`, `notif_pic`) VALUES
(4, 5, 'Dokumen TI', '3', '1', '2021-01-13', '2021-01-22', '4', 'fajar', '4', 'combinepdf1.pdf', 1, 0, 3, 0, 'Akan kadaluarsa', 2, 0),
(5, 5, 'Dokumen Bnjarsari', '3 ', '1', '2021-01-11', '2021-01-13', '2', 'fajar', '4', 'noisy-tube1.pdf', 1, 0, 3, 0, 'Akan kadaluarsa', 2, 2),
(6, 3, 'Dokumen TI', '31 ', '1', '2021-01-06', '2021-01-06', '3', 'fajar', '4', 'noisy-tube1_(5).pdf', 2, 0, 3, 0, 'Kadaluarsa', 1, 0),
(13, 3, '', '31', '- Pilih Jenis Dokumen -', '2021-01-06', '2021-01-06', '- Pilih PIC -', '', '3,12', 'noisy-tube1_(5)_(1)5.pdf', 2, 0, 0, 0, 'Kadaluarsa', 0, 0),
(14, 3, 'Dokumen TI', '31 ', '- Pilih Jenis Dokumen -', '2021-01-06', '2021-01-06', '- Pilih PIC -', '', '19', 'noisy-tube1_(5)_(1)4.pdf', 2, 0, 0, 0, 'Kadaluarsa', 0, 0);
...
(2, 'Aji', '$2y$10$TuF3HeuIyEN9K0PnQcOp6.XRnc2NB78OqsCwRB5hrDHIdDY1RQzhu', 1, 4, '087865018862', '754085719', '', 1, '2021-01-06 04:53:06'),
...
(4, 'Lutvi', '$2y$10$utHm6B03qYkK/WE1fz4m0e3tyouHv9yQdkIUtEhSXf/Y5O.yiX61y', 2, 12, '082134706151', '754085719', '', 1, '2020-12-16 07:11:49'),
(5, 'sekper', '$2y$10$a1VZjK75CF0yGK8z60tVWu6t9JnKXhWTrh6J/RX3YK7wu8Ac/PxPK', 2, 3, '087865018862', '754085719', '', 1, '2020-12-17 04:00:34'),
...
(21, 'admin', '$2y$10$KF3pM6WHF.UwYgYCW4vEVOx4Oh4Hw5bm5IhRNhmMjv/I0KYdn4ORi', 2, 0, '', '', '', 1, '2021-01-06 06:26:35');
...
--
ALTER TABLE `gap_histori_legal_ijin`
  MODIFY `id_histori_li` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
